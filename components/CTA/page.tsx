...
export default function CTASection() {
  ...
  return (
    <section className="py-20 relative overflow-hidden bg-white dark:bg-slate-950" ref={ref}>
      {/* Background Effects */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <div
            className={`inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white dark:bg-slate-800 shadow-lg mb-8 transition-all duration-600 ${
